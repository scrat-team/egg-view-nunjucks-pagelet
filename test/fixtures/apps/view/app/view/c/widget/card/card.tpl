<div class="card card-news" data-newsId="{{ item.newsId }}" data-categoryType="{{ item.categoryType }}">
  <a href="/detail/{{ item.newsId }}" data-pagelets="layout.header,layout.main" data-params="ctoken={{ ctoken }}"
     data-keep-scroll="">
    <div class="pic">
    ...
    <div class="con">
      ...
      <div class="item-sign">
        ...
        <div class="close">
          <div class="close-tips" tabindex="0" data-newsId="{{ item.newsId }}"
               data-categoryName="{{ item.categoryName }}">不感兴趣
          </div>
        </div>
      </div>
    </div>
